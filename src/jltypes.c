...
void jl_init_types(void) JL_GC_DISABLED
{
    ...
    *(size_t*)jl_an_empty_string = 0;
    ...
    //const static uint32_t binding_partition_constfields[] = { 0x0022 }; // Set fields 2, 5 as constant
    ...
    jl_binding_type =
        jl_new_datatype(jl_symbol("Binding"), core, jl_any_type, jl_emptysvec,
                        jl_perm_symsvec(4, "globalref", "partitions", "value", "flags"),
                        jl_svec(4, jl_any_type/*jl_globalref_type*/, jl_binding_partition_type, jl_any_type, jl_uint8_type),
                        jl_emptysvec, 0, 1, 1);
    const static uint32_t binding_atomicfields[] = { 0x0006 }; // Set fields 2, 3 as atomic
    jl_binding_type->name->atomicfields = binding_atomicfields;
    const static uint32_t binding_constfields[] = { 0x0001 }; // Set field 1 as constant
